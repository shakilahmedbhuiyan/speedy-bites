<template>
  <div class="flex flex-col w-full h-fit bg-[#374151] text-[#e5e7eb] px-16 py-14" bis_skin_checked="1">
    ...
    <div class="text-center" bis_skin_checked="1">© 2025 {{ $appName }} - All rights reserved.</div>
    <!---->
</div>
</template>
